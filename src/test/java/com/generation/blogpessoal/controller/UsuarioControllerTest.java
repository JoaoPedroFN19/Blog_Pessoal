...
public class UsuarioControllerTest {
	...
	@Test
	@Order(5)
	@DisplayName("Listar usuário específico")
	public void DeveListarUsuarioEspecifico() {

		Optional<Usuario> usuarioBusca = usuarioService.cadastrarUsuario(new Usuario(0L, "João Pedro",
				"joaopedro_flau@email.com.br", "1234", "https://i.imgur.com/EcJG8kB.jpg"));
	...
	public void deveAutenticarUsuario() {
		usuarioService.cadastrarUsuario(new Usuario(0L, "João Pedro", "joaopedro_flau@email.com.br", "1234",
				"https://i.imgur.com/EcJG8kB.jpg"));

		HttpEntity<UsuarioLogin> corpoRequisicao = new HttpEntity<UsuarioLogin>(
				new UsuarioLogin(0L, "", "joaopedro_flau@email.com.br", "1234", "", ""));
